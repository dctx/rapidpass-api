...
module or part of RapidPass, you may visit us and ask around at [#rapidpass-backend on slack](https://dctx.slack.com/).
...
* As a new developer of the RapidPass API, review existing [GitLab issues](https://gitlab.com/dctx/rapidpass/rapidpass-api/-/issues) first. New git branches should be created based on filed GitLab issues.  
* For details on how to run the project locally, please see [the quickstart guide](https://gitlab.com/dctx/rapidpass/rapidpass-api/-/wikis/guide/Quickstart-Guide).
...
5 Make sure that your commits are logical and atomic units.
6. The change you are introducing must have unit tests demonstrating the 
  correctness of the change.
7. Run all the unit tests locally to ensure that all the unit tests are passing.
8. Bump the project version as specified in `pom.xml` according to [Semantic Versioning](https://semver.org/).
9. Update the CHANGELOG.md file in the root project folder.
10. Commit your changes to your local MR branch.
11. Push your branch to origin.
12. Rename your MR to remove the WIP, signifying that it is ready to be merged. Apply the `Review` label on the MR. 
13. Message in the [#rapidpass-backend on slack](https://dctx.slack.com/) informing the maintainers that it is ready for review.
14. Maintainers will perform the code review and will merge the MR when it is satisfactory.
