...
public interface AccessPassRepository extends JpaRepository<AccessPass, Integer>, JpaSpecificationExecutor<AccessPass> {
    ...
    List<AccessPass> findAllByStatus(String status);

    List<AccessPass> findAllByStatusAndDateTimeUpdatedAfter(String status, OffsetDateTime dateTimeUpdated);
    ...
    List<AccessPass> findAllByReferenceIDAndPassTypeAndStatusInOrderByValidToDesc(String referenceId, String passType, List<String> statuses);
