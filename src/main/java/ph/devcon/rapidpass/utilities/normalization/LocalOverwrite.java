...
public class LocalOverwrite<E> implements NormalizationRule<E> {
    private final String field;
    private String replacement;
    private Function<String, Boolean> conditionForWriting;

    public LocalOverwrite(String field, String replacement, Function<String, Boolean> shouldOverwrite) {
        this.field = field;
