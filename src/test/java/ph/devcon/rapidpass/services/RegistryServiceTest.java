...
class RegistryServiceTest {
    ...
    @Test
    void generateQrPdf_INDIVIDUAL() throws IOException, WriterException, ParseException {
    ...
    @Test
    void generateQrPdf_VEHICLE() throws IOException, WriterException, ParseException {
